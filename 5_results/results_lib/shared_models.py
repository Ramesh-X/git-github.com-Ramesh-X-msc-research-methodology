...
class CorrelationAnalysis(BaseModel):
    ...
    cp_vs_ar: float | None = None  # Context Precision vs Answer Relevancy
    cp_vs_gmean: float | None = None  # Context Precision vs Geometric Mean
    f_vs_ar: float | None = None  # Faithfulness vs Answer Relevancy
