"""Pydantic-AI agents for E2-E4 experiments."""
...
from .models import E2Response, E3Response, E4Response
...
def create_e2_agent(model: OpenRouterModel):
    """E2: Standard RAG agent."""
...
Context will be provided in the user message."""
    ...
    logger.info("Created E2 Standard RAG agent")
    return agent


def create_e3_agent(model: OpenRouterModel):
    """E3: Filtered RAG agent (uses reranked context)."""
    system_prompt = """You are a retail customer support assistant.
Use the provided context to answer the user's question accurately.
...
Context will be provided in the user message."""
    ...
    logger.info("Created E3 Filtered RAG agent")
    return agent


def create_e4_agent(model: OpenRouterModel):
    """E4: Reasoning RAG agent with Chain-of-Thought."""
...
Context will be provided in the user message."""
    ...
    logger.info("Created E4 Reasoning RAG agent")
    return agent
